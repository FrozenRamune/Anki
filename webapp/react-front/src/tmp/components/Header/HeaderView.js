...
const styles = theme => ({
  ...
  search: {
    ...
    width: 36,
    backgroundColor: `rgba(${parseInt(theme.palette.common.black.substring(1,3), 16)}, ${parseInt(theme.palette.common.black.substring(3, 5), 16)}, ${parseInt(theme.palette.common.black.substring(5, 7), 16)}, 0`,
    transition: theme.transitions.create(["background-color", "width"]),
    "&:hover": {
      cursor: "pointer",
      backgroundColor: `rgba(${parseInt(theme.palette.common.black.substring(1,3), 16)}, ${parseInt(theme.palette.common.black.substring(3, 5), 16)}, ${parseInt(theme.palette.common.black.substring(5, 7), 16)}, 0.08`,
    }
  },
  searchFocused: {
    backgroundColor: `rgba(${parseInt(theme.palette.common.black.substring(1,3), 16)}, ${parseInt(theme.palette.common.black.substring(3, 5), 16)}, ${parseInt(theme.palette.common.black.substring(5, 7), 16)}, 0.08`,
